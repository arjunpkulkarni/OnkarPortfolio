...
export default function SkillsSection() {
  ...
  return (
    <section className="relative min-h-screen bg-[#151312] flex flex-col items-center justify-center overflow-hidden py-16">
      {/* Background Text */}
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 pointer-events-none select-none">
        <h2 className="text-[14.4vw] font-bold text-gray-200/20 select-none pointer-events-none leading-none tracking-tight z-0">
          Tools &
        </h2>
        <h2 className="text-[14.4vw] font-bold text-gray-200/20 select-none pointer-events-none leading-none tracking-tight z-0">
          Frameworks
      ...
      {/* Skill Badges */}
      <div className="relative z-10 flex flex-wrap justify-center gap-8 md:gap-11 mt-8">
        {skills.map((skill) => (
          <div
            key={skill.name}
            className="flex items-center gap-4 bg-zinc-900/80 backdrop-blur-sm px-6 py-3.5 rounded-full hover:scale-105 transition-all"
          >
